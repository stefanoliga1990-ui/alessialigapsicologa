# Contenuti della pagina di presentazione
...
Non aggiungere sedi, servizi, titoli o modalità di consulenza non forniti.

## Biografia professionale

Testo integrale del file `Biografia professionale.txt`, mantenuto nei suoi quattro paragrafi:
